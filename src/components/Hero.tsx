...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-40 right-32 w-48 h-48 bg-indigo-500/10 rounded-full blur-2xl animate-pulse delay-1000 animate-float"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-40 left-1/4 w-40 h-40 bg-cyan-500/15 rounded-full blur-xl animate-pulse delay-2000 animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-20 right-20 w-56 h-56 bg-blue-600/10 rounded-full blur-2xl animate-pulse delay-500 animate-float"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-1/2 left-10 w-24 h-24 bg-purple-500/15 rounded-full blur-lg animate-pulse animate-float"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute top-1/3 right-10 w-36 h-36 bg-cyan-400/10 rounded-full blur-xl animate-pulse animate-float"
        ...
        <div className="flex flex-col items-center justify-center min-h-screen text-center pt-16">
          ...
          <div className="max-w-4xl mx-auto animate-slide-up">
            ...
            <div className="flex justify-center space-x-8 mb-12">
              <div
                className="flex flex-col items-center group animate-zoom-in"
                style={{ animationDelay: "0.5s" }}
              >
              ...
              >
                <div className="p-4 rounded-full bg-indigo-500/20 group-hover:bg-indigo-500/30 transition-all duration-500 hover-scale animate-pulse-glow">
                  <Zap
                    className="h-8 w-8 text-indigo-300 animate-float"
                    style={{ animationDelay: "1s" }}
                  />
                </div>
                <span className="text-sm text-gray-300 mt-2 group-hover:text-white transition-colors duration-300">
              ...
              >
                <div className="p-4 rounded-full bg-cyan-500/20 group-hover:bg-cyan-500/30 transition-all duration-500 hover-scale animate-pulse-glow">
                  <Cpu
                    className="h-8 w-8 text-cyan-300 animate-float"
                    style={{ animationDelay: "2s" }}
                  />
                </div>
                <span className="text-sm text-gray-300 mt-2 group-hover:text-white transition-colors duration-300">
