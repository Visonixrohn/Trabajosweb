...
const esTranslations: Translations = {
  ...
  hero: {
    ...
    description:
      "VISONIXRO está a la vanguardia de la innovación tecnológica, proporcionando soluciones visuales avanzadas que transforman la manera en que interactuamos con la tecnología.",
    cta: "Descubre Más",
  },
  about: {
    ...
    visionText:
      "Ser una marca líder en innovación y confianza, conectando tecnología, diseño y propósito para transformar la experiencia de nuestros clientes en cada producto o servicio que ofrecemos.",
  ...
  services: {
    ...
    service1: {
      ...
      description:
        "Desarrollamos aplicaciones móviles y sistemas empresariales personalizados que automatizan procesos y mejoran la eficiencia operativa de tu negocio.",
      benefits: [
    ...
    service2: {
      ...
      description:
        "Diseñamos y desarrollamos sitios web modernos, responsivos y optimizados para SEO que convierten visitantes en clientes.",
      benefits: [
    ...
    service3: {
      ...
      description:
        "Gestionamos tu presencia en redes sociales con estrategias de contenido que aumentan el engagement y las ventas.",
      benefits: [
...
const enTranslations: Translations = {
  ...
  hero: {
    ...
    description:
      "VISONIXRO is at the forefront of technological innovation, providing advanced visual solutions that transform the way we interact with technology.",
    cta: "Discover More",
  },
  about: {
    ...
    vision: "Our Vision",
    visionText:
      "To be a leading brand in innovation and trust, connecting technology, design and purpose to transform our customers' experience in every product or service we offer.",
  ...
  services: {
    ...
    service1: {
      ...
      description:
        "We develop custom mobile applications and enterprise systems that automate processes and improve your business operational efficiency.",
      benefits: [
    ...
    service2: {
      ...
      description:
        "We design and develop modern, responsive and SEO-optimized websites that convert visitors into customers.",
      benefits: [
        "Global market reach",
    ...
    service3: {
      ...
      description:
        "We manage your social media presence with content strategies that increase engagement and sales.",
      benefits: [
